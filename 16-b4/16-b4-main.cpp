...
int main()
{
	...
	if (1) {
		...
		d1.set(2022, 11, 10);	//2022.11.10
		d2.set(2022, 11);		//2022.11.1
		d3.set(2022);		    //2022.1.1

		cout << "d1应该是2022.11.10，实际为：";
		d1.show();
		cout << "d2应该是2022.11,1， 实际为：";
		d2.show();
	...
	if (1) {
		Date d1(2022, 11, 10), d2(d1), d3(d1);

		cout << "测试set，部分不变" << endl;

		d1.set(2007, 0, 0); //2007.11.10
		d2.set(0, 10, 18);  //2022.10.18
		d3.set(0, 0, 28);   //2022.11.28

		cout << "d1应该是2007.11.10，实际为：";
		d1.show();
		cout << "d2应该是2022.10.18，实际为：";
		d2.show();
		cout << "d3应该是2022.11.28，实际为：";
		d3.show();
	...
	if (1) {
		...
		Date d12(2020, 2, 29), d13(2022, 10, 31);

		d12.set(2022, 0, 0); //2022.2.1
		d13.set(0, 11, 0);   //2022.11.1

		cout << "d12应该是2022.2.1， 实际为：";
		d12.show();
		cout << "d13应该是2022.11.1，实际为：";
		d13.show();
	...
	if (1) {
		...
		cout << "测试cout" << endl;
		cout << "d1应该是2022.11.10，实际为：" << d1 << endl;
	...
	if (1) {
		...
		cout << "请输入2022 2 29" << endl;
		cin >> d1;
		cout << "d1应该是2022.2.1，  实际为：" << d1 << endl;

		cout << "请输入1899 4 10" << endl;
		cin >> d1;
		cout << "d1应该是2000.4.10， 实际为：" << d1 << endl;

		cout << "请输入2022 13 10" << endl;
		cin >> d1;
		cout << "d1应该是2022.1.10， 实际为：" << d1 << endl;

		cout << "请输入2022 11 31" << endl;
		cin >> d1;
		cout << "d1应该是2022.11.1， 实际为：" << d1 << endl;
	...
	if (1) {
		...
		cout << "d4应该是44874，实际为：" << int(d4) << endl;
	...
	if (1) {
		...
		d2 = d1 + 27;
		cout << "d2应该是2022.12.7，    实际为：" << d2 << endl;

		d2 = 27 + d1;
		cout << "d2应该是2022.12.7，    实际为：" << d2 << endl;

		d2 = d1 - 25;
		cout << "d2应该是2022.10.16，   实际为：" << d2 << endl;
		...
		d1.set(2022, 2, 28);
		d2 = d1 + 3;
		cout << "d2应该是2022.3.3，     实际为：" << d2 << endl;

		d1.set(2021, 12, 28);
		d2 = d1 + 5;
		cout << "d2应该是2022.1.2，     实际为：" << d2 << endl;

		d1.set(2022, 1, 1);
		d2 = d1 - 5;
		cout << "d2应该是2021.12.27，   实际为：" << d2 << endl;
		...
		d1.set(2020, 12, 31);
		d2 = d1 + 366;
		cout << "d2应该是2022.1.1，     实际为：" << d2 << endl;
		...
		d1.set(2022, 11, 10);
		cout << "d1+27应该是2022.12.7， 实际为：" << d1 + 27 << endl;
		cout << "27+d1应该是2022.12.7， 实际为：" << 27 + d1 << endl;
		cout << "d1-25应该是2022.10.16，实际为：" << d1 - 25 << endl;
	...
	if (1) {
		...
		cout << "测试-date" << endl;
		cout << "日期差值应为48， 实际为：" << d1 - d2 << endl;

		d2.set(2022, 11, 15);
		cout << "日期差值应为-5， 实际为：" << d1 - d2 << endl;
	...
	if (1) {
		...
		d1.set(2022, 11, 10);
		d2 = d1++;
		cout << "d1应该是2022.11.11，实际为：" << d1 << endl;
		cout << "d2应该是2022.11.10，实际为：" << d2 << endl;

		d1.set(2022, 11, 10);
		d2 = ++d1;
		cout << "d1应该是2022.11.11，实际为：" << d1 << endl;
		cout << "d2应该是2022.11.11，实际为：" << d2 << endl;

		d1.set(2022, 11, 1);
		d2 = d1--;
		cout << "d1应该是2022.10.31，实际为：" << d1 << endl;
		cout << "d2应该是2022.11.1， 实际为：" << d2 << endl;

		d1.set(2022, 11, 1);
		d2 = --d1;
		cout << "d1应该是2022.10.31，实际为：" << d1 << endl;
		cout << "d2应该是2022.10.31，实际为：" << d2 << endl;

		d1.set(2021, 12, 31);
		d2 = d1++;
		cout << "d1应该是2022.1.1，  实际为：" << d1 << endl;
		cout << "d2应该是2021.12.31，实际为：" << d2 << endl;

		d1.set(2022, 1, 1);
		d2 = d1--;
		cout << "d1应该是2021.12.31，实际为：" << d1 << endl;
		cout << "d2应该是2022.1.1，  实际为：" << d2 << endl;
		...
		d1.set(2022, 2, 28);
		d2 = d1++;
		cout << "d1应该是2022.3.1，  实际为：" << d1 << endl;
		cout << "d2应该是2022.2.28， 实际为：" << d2 << endl;
		...
		d1.set(2022, 3, 1);
		d2 = d1--;
		cout << "d1应该是2022.2.28， 实际为：" << d1 << endl;
		cout << "d2应该是2022.3.1，  实际为：" << d2 << endl;
