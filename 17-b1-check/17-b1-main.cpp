...
int main()
{
	...
	{
		const char* s = "tongji";
		TStringAdv s1, s2;                 //s1为NULL
		s1.assign(s);
		s2.assign(s1);
		cout << "assign测试" << endl;
		cout << "s1应该是tongji，  实际输出：" << s1 << endl;
		cout << "s2应该是tongji，实际输出：" << s2 << endl;
	...
	if (1)
	{
		...
		TStringAdv s1 = "tongji", s2 = "-university", s3= "tju", s4 ;
		s1.append(s2);
		s2.append("111");
		s3.append("");
		s4.append('t');
		...
		cout << "append测试" << endl;
		cout << "s1应该是tongji-university，实际输出：" << s1 << endl;
		cout << "s2应该是-university111，   实际输出：" << s2 << endl;
		cout << "s3应该是tju，              实际输出：" << s3 << endl;
		cout << "s4应该是t，		   实际输出：" << s4 << endl;
	...
	if (1)
	{
		TStringAdv s1 = "tongj", s2 = "i", s3 = "ongji", s4 = "tji", s5 = "tongji";
		s1.insert(s2, 6);
		s3.insert('t', 1);
		s4.insert("ong", 2);
		s5.insert("i", 20);
		cout << "insert测试" << endl;
		cout << "s1应该是tongji，实际输出：" << s1 << endl;
		cout << "s3应该是tongji，实际输出：" << s3 << endl;
		cout << "s4应该是tongji，实际输出：" << s4 << endl;
		cout << "s5应该是tongji，实际输出：" << s5 << endl;
	...
	if (1)
	{
		TStringAdv s1 = "tongjii", s2 = "i", s3 = "tongjiiii", s4 = "tongjii";
		s1.erase(s2);
		s3.erase("iii");
		s4.erase('i');
		cout << "erase测试" << endl;
	...
	if (1)
	{
		TStringAdv s1 = "tongjiUNIV";
		cout << "strsub测试" << endl;
		cout << "s1应该是UNIV，  实际输出：" << s1.substr(7, 100) << endl;
		cout << "s2应该是ongji，实际输出：" << s1.substr(2, 5) << endl;
		cout << "s3应该是<NULL>，实际输出：" << s1.substr(20,20) << endl;
		wait_for_enter();
	}
	...
	if (1)
	{
		TStringAdv s1 = "tongjiUNIV";
		cout << "at测试" << endl;
		cout << "c1应该是t，实际输出：" << s1.at(0) << endl;
		cout << "c2应该是V，实际输出：" << s1.at(9) << endl;
		cout << "c3应该是 ，实际输出：" << s1.at(20) << endl;
		wait_for_enter();
	}
